...
<body>
    <main class="h-full text-white relative ">
        ...
        <div class="relative overflow-x-auto mx-12 my-10 shadow-md sm:rounded-lg">
            ...
            <table class="w-full my-8 text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
